...
/**
 * GlobeBackground - Vanta.js globe animation background
 * Features:
  ...
  useEffect(() => {
    ...
    const initializeVanta = () => {
      if (window.VANTA && window.VANTA.GLOBE && containerRef.current) {
        console.log('Initializing Vanta.js globe...');
        ...
        console.log('Vanta.js globe initialized successfully!');
      } else {
        console.log('Vanta.js not ready yet, retrying...');
